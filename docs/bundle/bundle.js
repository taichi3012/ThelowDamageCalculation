...
var app = (function (exports) {
    ...
    // (111:7) {#each over_strength_values as _, i}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file, 111, 8, 2905);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(111:7) {#each over_strength_values as _, i}",
    		ctx
    	});
    ...
    // (161:7) {#each Object.keys(skill_data) as id}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.value = option.__value;
    			add_location(option, file, 161, 8, 4698);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    			append_dev(option, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(161:7) {#each Object.keys(skill_data) as id}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 70, 2, 1493);
    			add_location(h40, file, 74, 5, 1618);
    			attr_dev(span0, "class", "text-big");
    			add_location(span0, file, 75, 5, 1636);
    			attr_dev(div0, "class", "vbox");
    			add_location(div0, file, 73, 4, 1593);
    			add_location(h41, file, 78, 5, 1735);
    			attr_dev(span1, "class", "text-big");
    			add_location(span1, file, 79, 5, 1757);
    			attr_dev(div1, "class", "vbox");
    			add_location(div1, file, 77, 4, 1710);
    			attr_dev(div2, "class", "hbox space-around");
    			add_location(div2, file, 72, 3, 1556);
    			attr_dev(div3, "class", "result vbox padding svelte-7wyjwt");
    			add_location(div3, file, 71, 2, 1518);
    			add_location(h20, file, 85, 4, 1933);
    			attr_dev(label0, "for", "weaponDamageInput");
    			add_location(label0, file, 87, 5, 1970);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "placeholder", "例:300");
    			add_location(input0, file, 88, 5, 2024);
    			attr_dev(section0, "class", "svelte-7wyjwt");
    			add_location(section0, file, 86, 4, 1954);
    			attr_dev(label1, "for", "specialDamageInput");
    			add_location(label1, file, 91, 5, 2131);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "例:50");
    			add_location(input1, file, 92, 5, 2181);
    			attr_dev(section1, "class", "svelte-7wyjwt");
    			add_location(section1, file, 90, 4, 2115);
    			attr_dev(label2, "for", "jobGainInput");
    			add_location(label2, file, 95, 5, 2288);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "placeholder", "例:10");
    			add_location(input2, file, 96, 5, 2336);
    			attr_dev(section2, "class", "svelte-7wyjwt");
    			add_location(section2, file, 94, 4, 2272);
    			attr_dev(label3, "for", "equipGainInput");
    			add_location(label3, file, 99, 5, 2437);
    			attr_dev(input3, "type", "number");
    			attr_dev(input3, "placeholder", "例:10");
    			add_location(input3, file, 100, 5, 2487);
    			attr_dev(section3, "class", "svelte-7wyjwt");
    			add_location(section3, file, 98, 4, 2421);
    			attr_dev(label4, "for", "parkGainInput");
    			add_location(label4, file, 103, 5, 2590);
    			attr_dev(input4, "type", "number");
    			attr_dev(input4, "placeholder", "例:140");
    			add_location(input4, file, 104, 5, 2638);
    			attr_dev(section4, "class", "svelte-7wyjwt");
    			add_location(section4, file, 102, 4, 2574);
    			add_location(span2, file, 107, 5, 2741);
    			...
    			add_location(select0, file, 109, 6, 2796);
    			attr_dev(input5, "class", "flex-grow-1");
    			attr_dev(input5, "type", "button");
    			input5.value = "OS値適用";
    			add_location(input5, file, 114, 6, 2981);
    			attr_dev(div4, "class", "hbox");
    			add_location(div4, file, 108, 5, 2770);
    			attr_dev(section5, "class", "svelte-7wyjwt");
    			add_location(section5, file, 106, 4, 2725);
    			attr_dev(div5, "class", "basicdamage panel padding svelte-7wyjwt");
    			add_location(div5, file, 84, 3, 1888);
    			add_location(h21, file, 120, 5, 3186);
    			attr_dev(label5, "for", "legendValueSelector");
    			add_location(label5, file, 122, 6, 3248);
    			option0.__value = "0";
    			option0.value = option0.__value;
    			add_location(option0, file, 124, 7, 3352);
    			option1.__value = "1";
    			option1.value = option1.__value;
    			add_location(option1, file, 125, 7, 3390);
    			option2.__value = "2";
    			option2.value = option2.__value;
    			add_location(option2, file, 126, 7, 3428);
    			option3.__value = "3";
    			option3.value = option3.__value;
    			add_location(option3, file, 127, 7, 3466);
    			if (/*numLegendStone*/ ctx[8] === void 0) add_render_callback(() => /*select1_change_handler*/ ctx[21].call(select1));
    			add_location(select1, file, 123, 6, 3307);
    			attr_dev(section6, "class", "vbox margin-1/2em");
    			add_location(section6, file, 121, 5, 3205);
    			attr_dev(input6, "id", "ms1");
    			attr_dev(input6, "type", "checkbox");
    			add_location(input6, file, 131, 6, 3553);
    			attr_dev(label6, "for", "ms1");
    			add_location(label6, file, 132, 6, 3632);
    			add_location(section7, file, 130, 5, 3536);
    			attr_dev(input7, "id", "ms2");
    			attr_dev(input7, "type", "checkbox");
    			add_location(input7, file, 135, 6, 3709);
    			attr_dev(label7, "for", "ms2");
    			add_location(label7, file, 136, 6, 3788);
    			add_location(section8, file, 134, 5, 3692);
    			attr_dev(input8, "id", "ms3");
    			attr_dev(input8, "type", "checkbox");
    			add_location(input8, file, 139, 6, 3865);
    			attr_dev(label8, "for", "ms3");
    			add_location(label8, file, 140, 6, 3944);
    			add_location(section9, file, 138, 5, 3848);
    			attr_dev(input9, "id", "ms4");
    			attr_dev(input9, "type", "checkbox");
    			add_location(input9, file, 143, 6, 4021);
    			attr_dev(label9, "for", "ms4");
    			add_location(label9, file, 144, 6, 4100);
    			add_location(section10, file, 142, 5, 4004);
    			attr_dev(input10, "id", "ms4.5");
    			attr_dev(input10, "type", "checkbox");
    			add_location(input10, file, 147, 6, 4177);
    			attr_dev(label10, "for", "ms4.5");
    			add_location(label10, file, 148, 6, 4260);
    			add_location(section11, file, 146, 5, 4160);
    			attr_dev(input11, "id", "ms5");
    			attr_dev(input11, "type", "checkbox");
    			add_location(input11, file, 151, 6, 4341);
    			attr_dev(label11, "for", "ms5");
    			add_location(label11, file, 152, 6, 4420);
    			add_location(section12, file, 150, 5, 4324);
    			attr_dev(div6, "class", "magicstone padding vbox");
    			add_location(div6, file, 119, 4, 3142);
    			add_location(h22, file, 156, 5, 4533);
    			attr_dev(label12, "for", "skillSelector");
    			add_location(label12, file, 158, 6, 4569);
    			if (/*skill*/ ctx[10] === void 0) add_render_callback(() => /*select2_change_handler*/ ctx[28].call(select2));
    			add_location(select2, file, 159, 6, 4615);
    			attr_dev(section13, "class", "svelte-7wyjwt");
    			add_location(section13, file, 157, 5, 4552);
    			attr_dev(label13, "for", "strengthEffectInput");
    			add_location(label13, file, 166, 6, 4821);
    			attr_dev(input12, "type", "number");
    			attr_dev(input12, "placeholder", "例:5");
    			add_location(input12, file, 167, 6, 4882);
    			attr_dev(section14, "class", "svelte-7wyjwt");
    			add_location(section14, file, 165, 5, 4804);
    			attr_dev(div7, "class", "othereffect svelte-7wyjwt");
    			add_location(div7, file, 155, 4, 4501);
    			attr_dev(div8, "class", "vbox panel svelte-7wyjwt");
    			add_location(div8, file, 118, 3, 3112);
    			attr_dev(div9, "class", "hbox space-around");
    			add_location(div9, file, 83, 2, 1852);
    			attr_dev(p, "class", "text-center");
    			add_location(p, file, 172, 2, 5010);
    			attr_dev(div10, "class", "container vbox svelte-7wyjwt");
    			add_location(div10, file, 69, 1, 1461);
    			add_location(main, file, 68, 0, 1429);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*darkMode*/ ctx[0] === undefined && !('darkMode' in props)) {
    			console_1.warn("<App> was created without expected prop 'darkMode'");
    		}
    	}
